...
theorem not_div_succ: m ∣ succ m → m=1 :=
begin
    assume h,
    cases h with a ha,
    ...
    rw mul_comm at ha,
    have : m ∣ 1,
        apply @div_remainder m (m*a) 1 m,
        refl,
        apply div_mul, refl,
        assumption,
    exact div_one m this,
end
